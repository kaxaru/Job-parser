...
class Role(Enum):
    ...
    DEVOPS = "DevOps"
    DATA_ENG = "Data Eng"
    # GenAI отделён от Data/ML СОЗНАТЕЛЬНО: LLM/RAG/агенты/промпты — другая профессия,
    # чем обучение моделей и фиче-инжиниринг, и смешивать их в одной корзине значит
    # сделать фильтр бесполезным для обеих сторон. Замер 14.08.2026 по 131 804 тайтлам:
    # роль набирает 2027 вакансий, забирая их почти целиком у Data/ML (1994), и та
    # остаётся с 12 156 — не пустеет. Границу держит порядок в ROLE_PATTERNS, см. там.
    GENAI = "GenAI"
    DATA_ML = "Data/ML"
    ANALYST = "Аналитик"
    EMBEDDED = "Embedded"
