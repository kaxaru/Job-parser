"""Value Object зарплаты. Единый источник gross→net (НДФЛ 13%), ПЕРИОДА вилки и конвертации
в RUB (раньше — parsing._salary_mid + infrastructure.net.rates.to_rub над примитивами).
